        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('update',$category->id)}}" method="post" id="quickForm">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-check">
                    <input type="radio" name="status" value="1" <?php echo $category->status == 1?'checked':'';?> class="form-check-inputs" id="exampleCheck">
                    <label class="form-check-label" for="exampleCheck1">Active</label>
                  </div>
                  <div class="form-check">
                    <input type="radio" name="status" value="0" <?php echo $category->status == 0?'checked':'';?> class="form-check-inputss" id="exampleCheck1">
